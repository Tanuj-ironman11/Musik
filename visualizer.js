      ...
      threeModulePromise = waitForGlobalThree()
        .then((THREE) => {
          ...
          class UnrealBloomPass extends Pass {
              ...
              setSize( width, height ) {
                  let resx = Math.round( width * this.resScale ), resy = Math.round( height * this.resScale );
          ...
          return { THREE, EffectComposer, RenderPass, UnrealBloomPass, ShaderPass, FXAAShader, DitherShader };
        })
